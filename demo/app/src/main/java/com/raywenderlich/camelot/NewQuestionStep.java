...
/**
 * The {@link org.researchstack.backbone.step.QuestionStep} class is a concrete subclass of {@link Step} that represents a step in
 ...
 */
public class NewQuestionStep extends QuestionStep {
     ...
     *                   task).
     */
    public NewQuestionStep(String identifier) {
        super(identifier);
    }
     ...
     */
    public NewQuestionStep(String identifier, String title) {
     ...
     */
    public NewQuestionStep(String identifier, String title, AnswerFormat format) {
        super(identifier, title);
    ...
    public Class getStepLayoutClass() {
        return NewSurveyStepLayout.class;
    }
